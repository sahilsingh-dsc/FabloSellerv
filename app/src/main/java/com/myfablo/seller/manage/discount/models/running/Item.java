...
public class Item {
     ...
     */
    public Item(String discountId, String customId, String discountTitle, String promoCode, Integer discountPercent, Integer maxDiscount, Integer minAmount, Boolean isFlatDiscount, Boolean isCustom) {
        super();
