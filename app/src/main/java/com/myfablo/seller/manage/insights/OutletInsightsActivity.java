package com.myfablo.seller.manage.insights;
...
public class OutletInsightsActivity extends AppCompatActivity implements View.OnClickListener {

    private ActivityOutletInsightsBinding binding;
    private Context context;

    private String selectedStartDate = "";
    private String selectedEndDate = "";

    private static final String TAG = "OutletInsightsActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityOutletInsightsBinding.inflate(getLayoutInflater());
        View view = binding.getRoot();
        setContentView(view);
        context = OutletInsightsActivity.this;
        initView();
    }
    ...
    private void getSellerProfit() {
        ...
        Call<SellerProfitResponse> call = ordersInterface.getOutletProfit(authPref.getBearerToken(), outletPref.getOutletId(), selectedStartDate, selectedEndDate);
