...
public class Item {
     ...
     * @param status
     */
    public Item(String orderId, String mpOrderId, List<Product> productList, Client client, Outlet outlet, Partner partner, Float payableAmount, String distance, String status, Amount amount, List<Timing> timing, Payment payment) {
        super();
